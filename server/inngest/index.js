...
// Inngest Function to delete workspace in database
                    ...
                    await step.run('send-task-reminder-email', async () => {
                        await sendEmail({
                            ...
                            body: `<div style="max-width: 600px;">
                                    ...
                                    <p style="font-size: 16px; ">You've been a task due in ${task.project.name}:</p>
                                    <p style="font-size: 18px; font-weight: bold; color: #007bff;
                                    margin: 8px 0;">${task.title}</p>
                                    ...
                                    <p style="margin-top: 20px; font-size: 14px; color: #6c757d;">
                                            please make sure to review and complete it before due date.
                                    </p>
                                    </div>`,
                        });
                    });
