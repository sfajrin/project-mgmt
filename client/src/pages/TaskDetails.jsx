...
const TaskDetails = () => {
    ...
    const fetchComments = async () => {
        ...
        try {
            ...
            // Only show error if not a 404 (not found is expected for no comments)
    ...
    const fetchTaskDetails = async () => {
        ...
        // Guard against undefined currentWorkspace
    ...
    const handleAddComment = async () => {
        ...
        try {
            ...
            // Smoothly refetch comments to update the UI without reload
            fetchComments();
        } catch (error) {
            toast.dismissAll();
            toast.error(error?.response?.data?.message || error.message);
